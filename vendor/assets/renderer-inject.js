...
((cssText, artDataUrl, themeConfig) => {
  const SELECTOR_CONTRACT = {"schema":"codex-dream-skin-selectors/1","selectors":[{"key":"shell-main","selector":"main.main-surface, main[class*=\"MainContentSurface\"]","tier":"L1","scope":"all","required":true},{"key":"left-panel","selector":"aside.app-shell-left-panel","tier":"L1","scope":"all","required":true},{"key":"header-tint","selector":"header.app-header-tint, :is(main.main-surface, main[class*=\"MainContentSurface\"]) > header","tier":"L1","scope":"all","required":true},{"key":"home-icon","selector":"[data-testid=\"home-icon\"]","tier":"L1","scope":"home","required":true},{"key":"home-route","selector":"[role=\"main\"]:has([data-testid=\"home-icon\"])","tier":"L1","scope":"home","required":true},{"key":"home-route-css","selector":"[role=\"main\"]","tier":"L1","scope":"home","required":true},{"key":"home-banners","selector":".home-banners","tier":"L2","scope":"home","required":false},{"key":"composer-chrome","selector":".composer-surface-chrome, [class*=\"ComposerLayoutRoot\"]","tier":"L2","scope":"home+thread","required":false},{"key":"composer-toolbar","selector":".composer-surface-chrome [class*=\"_footer_\"], [class*=\"ComposerLayoutRoot\"] [class*=\"ComposerLayoutFooter\"]","tier":"L2","scope":"home+thread","required":false},{"key":"home-utility","selector":"[class*=\"_homeUtilityBar_\"]","tier":"L2","scope":"home","required":false},{"key":"game-source","selector":"[data-feature=\"game-source\"]","tier":"L2","scope":"home","required":false},{"key":"home-suggestions","selector":".group\\/home-suggestions","tier":"L2","scope":"home","required":false},{"key":"project-selector","selector":".group\\/project-selector","tier":"L2","scope":"home config","required":false},{"key":"markdown","selector":"[class*=\"_markdown\"]","tier":"L2","scope":"thread","required":false},{"key":"thread-surface","selector":".thread-scroll-container","tier":"L2","scope":"thread","required":false},{"key":"message","selector":"[data-message-author-role]","tier":"L2","scope":"thread","required":false},{"key":"appearance-radio","selector":"input[name=\"appearance-theme\"]","tier":"L2","scope":"settings","required":false},{"key":"settings-search","selector":"input[placeholder*=\"搜索设置\"], input[placeholder*=\"Search settings\"]","tier":"L1","scope":"settings","required":false},{"key":"overlay-menu","selector":"[role=\"menu\"]","tier":"L2","scope":"overlay","required":false},{"key":"overlay-dialog","selector":"[role=\"dialog\"]","tier":"L2","scope":"overlay","required":false},{"key":"overlay-popper","selector":"[data-radix-popper-content-wrapper]","tier":"L2","scope":"overlay","required":false}],"stableTestids":["app-shell-header-context-menu-surface","home-icon","theme-preview"]};
  ...
  const ROOT_ATTRS = [
    "data-dream-skin", SHELL_ATTR, "data-dream-route", "data-dream-workspace-surface",
    "data-dream-theme-id", "data-dream-semantic-success", "data-dream-semantic-danger",
  ...
  const THEME_VARIABLES = [
    ...
    "--ds-cyan", "--ds-purple", "--ds-text", "--ds-muted", "--ds-line", "--ds-success", "--ds-danger",
    "--ds-bg-rgb", "--ds-panel-rgb", "--ds-panel-2-rgb", "--ds-sidebar-rgb", "--ds-workspace-surface-rgb", "--ds-success-rgb", "--ds-danger-rgb", "--ds-accent-rgb",
    ...
    "--ds-theme-color-panel-alt", "--ds-theme-color-workspace-surface", "--ds-theme-color-accent",
    "--ds-theme-color-accent-alt", "--ds-theme-color-secondary",
    "--ds-theme-color-highlight", "--ds-theme-color-text",
    "--ds-theme-color-muted", "--ds-theme-color-line", "--ds-theme-color-success", "--ds-theme-color-danger",
  ...
  const applyTheme = (root, shell) => {
    ...
    const sidebar = explicit.has("sidebar") ? pick("sidebar") : panel;
    const workspaceSurface = explicit.has("workspaceSurface") ? pick("workspaceSurface") : undefined;
    setAttribute(root, "data-dream-workspace-surface", workspaceSurface ? "true" : "false");
    setAttribute(root, "data-dream-theme-id", THEME.id || "");
    setAttribute(root, "data-dream-semantic-success", explicit.has("success") ? "true" : "false");
    setAttribute(root, "data-dream-semantic-danger", explicit.has("danger") ? "true" : "false");
    const variables = {
      "--ds-bg": pick("background"),
      "--ds-panel": panel,
      "--ds-panel-2": pick("panelAlt"),
      "--ds-sidebar": sidebar,
      "--ds-workspace-surface": workspaceSurface,
      "--ds-green": accent,
      "--ds-lime": accentAlt,
      ...
      "--ds-success": explicit.has("success") ? colors.success : undefined,
      "--ds-danger": explicit.has("danger") ? colors.danger : undefined,
    };
    ...
    const publicColors = {
      ...
      "--ds-theme-color-workspace-surface": variables["--ds-workspace-surface"],
      ...
      "--ds-theme-color-success": variables["--ds-success"],
      "--ds-theme-color-danger": variables["--ds-danger"],
    };
    ...
    const rgbVariables = {
      ...
      "--ds-sidebar-rgb": variables["--ds-sidebar"],
      "--ds-workspace-surface-rgb": variables["--ds-workspace-surface"],
      "--ds-success-rgb": variables["--ds-success"],
  ...
  const detectScope = () => {
    ...
    if (selectorHit("settings-search") || selectorHit("appearance-radio") || stableTestidHit("theme-preview")) baseState = "settings";
  ...
  const refreshScope = () => {
    ...
    setAttribute(document.documentElement, "data-dream-route", scope.baseState);
  ...
  let lastSettingsSearchPresent = false;
  const settingsSearchPresent = () => selectorHit("settings-search");
  const scheduleRouteEnsure = () => {
    const present = settingsSearchPresent();
    if (present !== lastSettingsSearchPresent) {
      lastSettingsSearchPresent = present;
  ...
  if (typeof MutationObserver === "function") {
    ...
    partObserver = new MutationObserver(scheduleRouteEnsure);
  }
  ...
  lastSettingsSearchPresent = settingsSearchPresent();
